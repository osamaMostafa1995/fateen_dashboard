<template>
  <CRow>
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader>
          <strong>وسائل التواصل الأجتماعى</strong>
        ...
        <CTable hover small responsive="sm" striped v-if="!isLoading">
          <CTableHead>
            <CTableRow color="dark">
              ...
              <CTableHeaderCell scope="col">إدارة الوسيلة</CTableHeaderCell>
            </CTableRow>
          </CTableHead>
          ...
          <CTableBody>
            <CTableRow v-for="blog in blogs" :key="blog">
              ...
              <CTableDataCell v-if="blog?.logo_url">
                <CImage
                  rounded
                  thumbnail
                  :src="blog?.logo_url"
              ...
              <CTableDataCell> {{ blog?.url }}</CTableDataCell>
        ...
        >
          <CModalHeader>
            <CModalTitle>إدارة الوسائل الأجتماعية</CModalTitle>
          </CModalHeader>
